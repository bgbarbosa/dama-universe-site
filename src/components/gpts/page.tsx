...
export const metadata = createPageMetadata({
  ...
  description:
    "Assistentes de IA personalizados criados para apoiar tarefas específicas de documentação, estudo, organização, análise e produção técnica.",
  path: "/gpts",
});
        ...
        <div className="mb-8 grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
          <MetallicCard variant="notice">
            ...
            <p className="mt-4 text-sm leading-7 text-muted">
              Cada GPT personalizado possui uma função específica, indicação de
              uso e cuidados necessários. Eles funcionam como ferramentas de
              apoio, não como substitutos da conferência humana,
              responsabilidade técnica ou validação final.
            </p>
          </MetallicCard>
